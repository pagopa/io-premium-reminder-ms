...
public class AbstractMock {
    ...
    protected void mockGetPaymentsByRptId(Reminder reminder) {
        ...
        Mockito.when(mockRepository.getPaymentByRptId(Mockito.anyString(), Mockito.anyString())).thenReturn(listReminder);
    }
    ...
    protected void mockGetReadMessageToNotifyWithResponse(List<Reminder> pageReturnReminder) {
        Mockito.when(mockRepository.getReadMessageToNotify(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt(),
    ...
    protected void mockGetPaidMessageToNotifyWithResponse(List<Reminder> pageReturnReminder) {
        Mockito.when(mockRepository.getPaidMessageToNotify(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt(),
                Mockito.any(LocalDateTime.class), Mockito.any(LocalDate.class), Mockito.any(LocalDateTime.class),
    ...
    protected void mockGetPaymentByRptId(List<Reminder> rem) {
        Mockito.when(mockRepository.getPaymentByRptId(Mockito.anyString(), Mockito.anyString())).thenReturn(rem);
    }
    ...
    protected Reminder selectReminderMockObject(String type, String id, String contentType, String fiscalCode,
    ...
    protected message selectMessageMockObject(String type, String id, String contentType, String fiscalCode,
                                              String noticeNumber) {
